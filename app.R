...
server = function(input, output, session) {
  ...
  # central accordion
  mapvalues <- leafletmapServer('mod_map',
             r_neosites_data = reactive({ neosites_data() }),
             r_lake_data = reactive({ lake_data() }),
             nooptions = values$nooptions,
             modify = values$modify,
             removelakes = reactive({ input$removelakes }) )

 userdecisionsServer('mod_user_decisions',
                                  neositeid = reactive({ input$neositeid }),
                                  modify = values$modify,
                                  nooptions = values$nooptions,
