...
test_that("{shinytest2} recording: neotoma-lakes", {
  ...
  app$set_window_size(width = 1333,
                      height = 800)
  app$click("search")
  ...
  app$set_inputs(lakeinfo_rows_all = c(1, 2, 3, 4, 5),
                 allow_no_input_binding_ = TRUE)
  app$set_inputs(lakeinfo_state = c(1701994431296,
                                    0, 10, "",
                                    TRUE, FALSE, TRUE,
      c(TRUE, "", TRUE, FALSE, TRUE),
      c(TRUE, "", TRUE, FALSE, TRUE)),
  ...
  app$set_inputs(map_bounds = c(36.0424367353279,
                                ...
                                135.170288085938),
      allow_no_input_binding_ = TRUE)
  app$set_inputs(map_center = c(136.067047119141,
                                35.3509759564216),
                 allow_no_input_binding_ = TRUE)
  app$set_inputs(map_groups = c("Esri.WorldImagery",
  ...
  app$set_inputs(map_draw_all_features = c("FeatureCollection",
      ...
      allow_no_input_binding_ = TRUE)
  app$set_inputs(map_draw_stop = "polygon",
                 allow_no_input_binding_ = TRUE)
  ...
  app$set_inputs(map_center = c(136.068420410156,
                                35.3509759564216),
                 allow_no_input_binding_ = TRUE)
  app$set_window_size(width = 1333, height = 800)
  app$expect_values()
