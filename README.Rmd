...
The Neotoma Paleoecology Database (“Neotoma”) is more than a database! Neotoma
is a database, a software ecosystem, and a community.
...
2. 2. Water bodies from the [Hydrolake DB](https://wp.geog.mcgill.ca/hydrolab/hydrolakes/) near the site will be displayed in blue. 
Clicking on these water bodies allows you to access information within 
the HYDROLAKE DB associated with each lake on the right panel. If one of these
